...
# CUDA_VISIBLE_DEVICES=0 python train_RED.py --dataroot /home/nas2_userH/yeojeongpark/compression/dataset \
# --name RED_v2c_lpips_8conv_actGAN_new --dataset_mode video --main_G_path checkpoints/v2c_experiment/2_net_G_A.pth \
# --gpu_ids 0 --no_dropout --pool_size 0 --batchSize 8 --niter_decay 200 --niter 2800 --save_epoch_freq 300 --save_latest_freq 10000 \
# --lpips --n_convs 8 --actl1 --act_GAN_loss --tensorboard_dir tensorboard/

# CUDA_VISIBLE_DEVICES=0 python train_RED.py --dataroot /home/nas2_userH/yeojeongpark/compression/dataset \
# --name RED_v2c_lpips_8conv_actGAN_fm --dataset_mode video --main_G_path checkpoints/v2c_experiment/2_net_G_A.pth \
# --gpu_ids 0 --no_dropout --pool_size 0 --batchSize 8 --niter_decay 200 --niter 2500 --save_epoch_freq 300 --save_latest_freq 10000 \
# --lpips --n_convs 8 --actl1 --act_GAN_loss --lambda_feature 1.0 --tensorboard_dir tensorboard/

CUDA_VISIBLE_DEVICES=3 python train_RED.py --dataroot /home/nas2_userH/yeojeongpark/compression/dataset \
--name RED_v2c_lpips_8conv_actGAN_td --dataset_mode video --main_G_path checkpoints/v2c_experiment/2_net_G_A.pth \
--gpu_ids 0 --no_dropout --pool_size 0 --batchSize 8 --niter_decay 200 --niter 2500 --save_epoch_freq 300 --save_latest_freq 10000 \
--lpips --n_convs 8 --actl1 --act_GAN_loss --Temporal_GAN_loss --tensorboard_dir tensorboard/

# CUDA_VISIBLE_DEVICES=2 python train_RED.py --dataroot /home/nas2_userH/yeojeongpark/compression/dataset \
# --name RED_v2c_lpips_8conv_actGAN_td_fm --dataset_mode video --main_G_path checkpoints/v2c_experiment/2_net_G_A.pth \
# --gpu_ids 0 --no_dropout --pool_size 0 --batchSize 8 --niter_decay 200 --niter 2500 --save_epoch_freq 300 --save_latest_freq 10000 \
# --lpips --n_convs 8 --actl1 --act_GAN_loss --Temporal_GAN_loss --lambda_feature 1.0 --tensorboard_dir tensorboard/
