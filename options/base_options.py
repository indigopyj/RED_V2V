...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--loadSizeH', type=int, default=286, help='scale images to this size')
        self.parser.add_argument('--loadSizeW', type=int, default=542, help='scale images to this size')
        self.parser.add_argument('--fineSizeH', type=int, default=256, help='then crop to this size')
        self.parser.add_argument('--fineSizeW', type=int, default=512, help='then crop to this size')
        self.parser.add_argument('--resize_mode', type=str, default='rectangle', help='')
        self.parser.add_argument('--crop_mode', type=str, default='rectangle', help='')
